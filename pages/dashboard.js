                          ...
                          <div className="w-2/4 flex">
                            ...
                            <div className="px-4 py-1.5 h-10 w-22 mt-2">
                              <div className="text-base dark:text-white">
                                {projects.filter((project) => project._id.$oid == task.project)
                                  .map((filteredProject) => filteredProject.value)}
                              </div>
                            </div>
                          </div>
                          <div className="flex w-2/4">
                            <div className="noClickZone border-x w-22 h-10 pr-2 mx-3 my-1.5">
                            ...
                            <div className="noClickZone border-r h-10 w-22 pr-3 my-1.5 mx-2">
                              ...
                              childTask.parentTaskId && childTask.parentTaskId == task._id.$oid ?
                                <div key={index} className={`child noClickZone flex bg-gray-50 border-b border-x max-w-full h-14 hidden`}>
                                  <div className="w-2/4 flex cursor-pointer">
                                    ...
                                    <div className="px-4 py-1.5 h-10 w-22 mt-2">
                                      <div className="text-base dark:text-white">
                                        {projects.filter((project) => project._id.$oid == childTask.project)
                                          .map((filteredProject) => filteredProject.value)}
                                      </div>
                                    </div>
                                  </div>
