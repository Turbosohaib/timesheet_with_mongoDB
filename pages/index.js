              ...
              {tasksData.map((task, index) => {
                return (
                  !task.parentTaskId ?
                    <div key={index}>
                      <div>
                        <div className="max-w-full h-9 bg-slate-100 mt-5">
                          <div className="px-3 py-2 text-sm text-slate-400 font-sans">
                            {renderDate(task.startTime)}
                          </div>
                        </div>
                        <div className="flex border shadow-lg  max-w-full h-14 bg-white">
                          <div className="w-2/4 flex">
                            <div className="w-72 px-6 py-4  text-base  whitespace-nowrap ">{task.taskName}</div>
                          ...
                          <div className="flex w-2/4">
                            ...
                            <div className="border-r h-10 w-22 pr-3 my-1.5 mx-2">
                              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-currency-pound mt-1.5" width="32" height="28" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div className="border-l my-1.5 h-10 w-24">
                        ...
                        {tasksData.map((childTask, index) => {
                          return (
                            childTask.parentTaskId && childTask.parentTaskId == task._id.$oid ? <div className={`flex border shadow-lg ${children ? 'hidden' : ''} max-w-full h-14 bg-white`}>
                              <div className="w-2/4 flex">
