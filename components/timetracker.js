...
export default function Timetracker({ setTasksData }) {
    ...
    async function handleSubmit() {
        ...
        const data = {
            ...
            startTime: updatedTrackTime.startTime,
            stopTime: updatedTrackTime.stopTime,
            seconds: updatedTrackTime.seconds
        }
            ...
            <tbody>
                <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <input type="text" id="taskName" name="taskName" placeholder="What are you working on?" class="mt-1 flex h-11 w-full items-center justify-center rounded-xl border bg-white/0 p-3 text-sm outline-none  text-dark-500 placeholder:text-dark-500  " />
                    </th>
                    <td class="px-6 py-4">
                        <select id="project" name="project" class="border border-gray-300 text-dark-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 placeholder:text-dark-500 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
